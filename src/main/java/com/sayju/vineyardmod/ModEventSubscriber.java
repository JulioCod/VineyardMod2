...
import com.sayju.vineyardmod.init.ModItemGroups;
...
@EventBusSubscriber(modid = VineyardMod.MODID, bus = EventBusSubscriber.Bus.MOD)
public class ModEventSubscriber {
    ...
    public static <T extends IForgeRegistryEntry<T>> T setup(final T entry, final String name) {
        return setup(entry, new ResourceLocation(VineyardMod.MODID, name));
    }
